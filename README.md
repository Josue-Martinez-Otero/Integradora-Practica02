...
Si en nuestra documentación necesitamos incluir información en modo de lista, un elemento tras otro podemos hacerlo utilizando un números con un punto 
decimal si las deseamos ordenadas o un guión medio - si solo queremos una viñeta.
...
dentro del mismo repositorio o fuera de el. y se maquetan utilizando los corchetes \[ \], inmediantamente despues pondrémos la liga de referencia 
entre parentesis \( \).
...
Documentación creada por: ***Alumno Josue Atlai Martinez Otero***
...
8. Haz clic en "Add file" y selecciona "Upload files".
   - **Como agregar:** Arrastra y suelta tu imagen en el área de carga. Añade un mensaje de commit y haz clic en "Commit changes".
   - **En comandos:** Usar la Línea de Comandos coloca la imagen en el directorio de tu repositorio local. Para agregar la imagen: 
       ruta/tucuenta/repocitorio/imagen.png.
    >- Puedes referenciar o poner un mensaje con ![  ].
    >- Obligatoriamente el hipervinculo debera ir en ( / / ).
  3. Guardar los cambios.
...
| Encabezado 1 | Encabezado 2 | Encabezado 4|
|--------------|--------------|-------------|
...
en el caso de necesitar la fusión de filas utilizamos la propiedad *rowspan* .
...
Dado que en el ejemplo pasado usando solo markdown no se puede realizar la fusión de filas debemos 
